  ...
  return (
    <div className="h-screen flex bg-slate-50 overflow-hidden">
          ...
          <div className="p-6 flex flex-col overflow-hidden">
            ...
            <div className="border-t border-slate-200 pt-4 mt-4">
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-lg text-red-600 font-medium hover:bg-red-50 transition-colors w-full"
              >
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        {/* Topbar */}
        <header className="flex-shrink-0 flex items-center justify-between bg-white border-b border-slate-200 px-4 py-3 shadow-sm z-50 relative">
