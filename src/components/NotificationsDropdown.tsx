    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <>
          ...
          />
          <div className="fixed sm:absolute top-20 sm:top-auto left-4 right-4 sm:left-auto sm:right-0 sm:mt-2 w-auto sm:w-80 max-w-md bg-white border border-slate-200 rounded-lg shadow-2xl z-[100] animate-fade-in sm:mr-0 ring-1 ring-black/5">
